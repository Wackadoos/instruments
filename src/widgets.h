...
static inline auto GPS_WIDGET = SetpointWidget(&SensorState::fix_satellites, {480, 0, TextAlign::RIGHT, RGB565_BLUE, 3, 0, {&SensorState::sat_string, 3, 0, 0}}, &GPS_WARNING_SETPOINT, &GPS_ERROR_SETPOINT, RGB565_BLUE, RGB565_YELLOW, RGB565_RED, true);
