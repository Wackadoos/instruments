...
// #define NMEAGPS_PARSE_GLL // Geographic Position, Latitude/Longitude
#define NMEAGPS_PARSE_GSA  // GPS DOP and Active Satellites
#define NMEAGPS_PARSE_GSV  // Satellites in View
// #define NMEAGPS_PARSE_GST // Pseudorange Noise Statistics
#define NMEAGPS_PARSE_RMC  // Recommended Minimum Navigation Information
// #define NMEAGPS_PARSE_VTG // Track Made Good and Ground Speed
#define NMEAGPS_PARSE_ZDA  // Time & Date
...
#define NMEAGPS_MAX_SATELLITES (30)
...
//------------------------------------------------------
//  Because the NMEA checksum is not very good at error detection, you can
